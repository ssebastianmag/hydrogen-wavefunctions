...
parser = argparse.ArgumentParser(
    description='Hydrogen Wavefunction electron probability-density plot '
                'by definition of quantum numbers n, l, m and a bohr radius augmentation coefficient'
)

parser.add_argument('n', help='(n) Principal quantum number (dtype: integer) (1 <= n)', type=int)
parser.add_argument('l', help='(l) Azimuthal quantum number (dtype: integer) (0 <= l <= n-1)', type=int)
parser.add_argument('m', help='(m) Magnetic quantum number (dtype: integer) (-l <= m <= l)', type=int)
parser.add_argument('a0', help='(a0) Bohr radius augmentation coefficient (dtype: float) (0 < a0 <= 1)', type=float)
parser.add_argument('-dp', help='Dark palette: Plot with a less bright color scheme',
...
plot_wavefunction(args.n, args.l, args.m, args.a0, args.dp)
