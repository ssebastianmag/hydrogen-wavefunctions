...
if __name__ == "__main__":
    ...
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", k=2, exposure=1)
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", use_dark_theme=True, k=2, exposure=1)
    ...
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", k=2.5, exposure=0.5)
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", use_dark_theme=True, k=2.5, exposure=0.5)
    ...
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", k=2.5, exposure=1.5)
    plot_hydrogen_wavefunction_xz(wf, colormap="rocket", use_dark_theme=True, k=2.5, exposure=1.5)
